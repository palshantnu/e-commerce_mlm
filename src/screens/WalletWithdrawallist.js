...
const WalletWithdrawallist = ({navigation}) => {
 ...
 useEffect(() => {
  ...
  const ListHeader = () => {
    ...
    return (
      ...
      <View style={styles.row}>
            <Text style={[styles.cell,{ fontSize: 16,paddingHorizontal:10,width:50}]}>#</Text>
            <Text style={[styles.cell,{ fontSize: 16,paddingHorizontal:10}]}>NAME</Text>
            <Text style={[styles.cell,{ fontSize: 16,paddingHorizontal:10}]}>ACCOUNT HOLDER NAME</Text>
            <Text style={[styles.cell,{ fontSize: 16,paddingHorizontal:10,color:'#111'}]}>ACCOUNT NUMBER</Text>
            <Text style={[styles.cell,{ fontSize: 16,paddingHorizontal:10,color:'#111'}]}>IFSC</Text>
            <Text style={[styles.cell,{ fontSize: 16,}]}>AMOUNT</Text>
            <Text style={[styles.cell,{ fontSize: 16,color:'#1be6db'}]}>STATUS</Text>
            <Text style={[styles.cell,{ fontSize: 16,}]}>DATE TIME</Text>
      </View>
      </View>
    );
  };
  ...
  const renderCartItem = (item,index) => {
    ...
    <ScrollView>
      <View style={styles.row}>
            <Text style={[styles.cell,{color:'#444',width:50}]}>{item.id}</Text>
            <Text style={[styles.cell,{}]}>{user.user_name}</Text>
            <Text style={[styles.cell,{}]}>{item.name}</Text>
            <Text style={[styles.cell,{}]}>{item.bankaccountnumber}</Text>
            <Text style={[styles.cell,{color:'#111'}]}>{item.ifsc}</Text>
            <Text style={[styles.cell,{color:'#111'}]}>{item.amount}</Text>
            <Text style={[styles.cell,{color:'#1be6db'}]}>{item.status == 0 ?'Pending':'Success'}</Text>
            <Text style={[styles.cell,{color:'#111'}]}>{item.datetime}</Text>
  ...
  const getUserCart = async () => {
    ...
    let body = {
      ...
      const res = await postData('walletlist', body);
    ...
    <View style={styles.container}>
      <ScrollView
        ...
        <View style={{flexDirection: 'row', padding: 20}}>
          ...
          <Text style={styles.title}>Withdrawal List</Text>
        </View>
    ...
    <View horizontal style={styles.container1}>
     ...
     <View style={styles.table}>
        ...
        {loading ? (
          ...
          <Text style={styles.title}>Requests Not Found!</Text>
          {/* <Button
            color={Color.primary}
            title="Shop Now"
            onPress={() => {
